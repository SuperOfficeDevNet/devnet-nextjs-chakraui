          ...
          >
            <Box pt="5" pb="6" px="5">
              ...
              <SimpleGrid as="nav" gap="6" mt="8" columns={{ base: 1, sm: 2 }}>
                <NavLink.Mobile icon={HiCloudDownload}>Features</NavLink.Mobile>
                <NavLink.Mobile icon={HiBookOpen}>About</NavLink.Mobile>
              ...
              <VStack mt="8" spacing="4">
                ...
                <Box textAlign="center" fontWeight="medium">
                  Already installed?{' '}
                  <Box as="a" color={mode('teal.600', 'teal.400')}>
                    Login
                  </Box>
                </Box>
              </VStack>
